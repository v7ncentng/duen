...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription: 'Automated drink dispenser built by the Spring 2024 cohort.',
    description: 'The Spring 2024 cohort built an automated drink dispenser as their cohort project.',
    highlights: ['Drink dispenser', 'Automation'],
  },
  {
